export default [
...

  {
    ...
    description: {
      ...
      fr: 'La magie intérieure de ces pierres permet aux sages de se protéger pendant les prédictions d\'avenirs et les autres activités des voyants.',
...

  {
    ...
    description: {
      ...
      fr: 'Les rumeurs sur l\'immortalité et la transmutation ont inspiré les utilisateurs de la magie à expérimenter et à créer des pierres comme celle-ci. Ces orbes sont devenues utiles pour augmenter la puissance magique bien que les résultats expérimentaux n\'aient pas atteint leurs intentions originales.',
...

  {
    ...
    description: {
      ...
      fr: 'Il s\'agit d\'un fantastique composant magique qui s\'enchante facilement. Des objets pratiques comme celui-ci sont souvent dotés de pouvoirs innés et peuvent souvent être trouvés dans les échanges commerciaux entre marchands.',
...

  {
    ...
    description: {
      ...
      fr: 'Ce puissant objet magique est souvent utilisé pour contrôler les éléments et inspirer la peur dans le cœur des ennemis. Nüwa, un légendaire utilisateur de la magie, provenant d\'une faction de monstre, a fabriqué de nombreux objets comme celui-ci.',
...

  {
    ...
    description: {
      ...
      fr: 'Des objets comme celui-ci ont été créés à partir de météores et furent utilisés à mauvais escient comme symboles sacrés. Bien qu\'ils ne soient plus utilisés comme symboles sacrés, les yeux de Baetylus dégagent un pouvoir magique considérable.',
...

  {
    ...
    description: {
      ...
      fr: 'Les pierres Benben ont été placées au sommet des pyramides d\'une ancienne race morte. Les pierres ont absorbé des milliers d\'années d\'énergie solaire, qui serait un cadeau d\'une divinité solaire.',
...

  {
    ...
    description: {
      ...
      fr: 'De vieilles pierres de serpent comme celle-ci ont été trouvées sur des autels oubliés à l\'intérieur de ruines antiques. Les savants disent que les pierres ont probablement été utilisées pour adorer une divinité de serpent, mais les textes trouvés dans les ruines n\'ont pas encore été traduits avec succès.',
...

  {
    ...
    description: {
      ...
      fr: 'Le phylactère d\'une liche contient l\'âme d\'une puissante créature morte-vivante. Les phylactères plus anciennes sont accompagnées de puissants enchantements pour protéger le porteur - et l\'âme contenue à l\'intérieur.',
