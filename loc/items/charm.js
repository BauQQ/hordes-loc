export default [
  {
    ...
    description: {
      ...
      ru: 'Колокола часто используются как символ преданности избранному богу. Внутри этого колокола есть серебряная надпись, но перевод этой надписи потерян во времени.',
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Les œufs de monstres fossilisés sont souvent interprétés comme des symboles de longévité. Cependant, il n\'existe aucune trace écrite de ces créatures au-delà de l\'époque récente.',
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Les tribus orques gardent souvent le crâne de leurs dignes ennemis en signe de respect. Ce crâne est orné de tatouages qui symbolisent le pouvoir que possédait l\'ennemi de son vivant.',
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Les drapeaux qui flottaient au sommet des navires de guerre étaient appelés fanions. Ce fanion figurait parmi les navires de guerre naufragés qui se sont rendus pour la première fois à Headless Landing.',
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Les mages ont créé des méthodes alternatives pour acquérir du mana pendant les périodes de pénurie. Cette bille a été créée pendant la crise des Arcanes, une période où les réseaux de mana étaient soumis à un stress extrême.',
