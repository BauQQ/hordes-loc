export default {
  interactions: [{
    text: {
      ...
      da: 'Bebyrdede sind, er fyldt med mange meninger; en kop kan være meget nytting, hvis den tømmes først. Hvordan kan jeg være behjælpelig for dig, på din vej mod at blive mere oplyst?'
    },
    ...
    choices: [{
      ...
      zh: '重製我的屬性點 ( $g$1 )',
      da: 'Nulstil mine stat points ( $g$1 ).'
    }]
  }]
}
