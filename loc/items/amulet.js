export default [
...

  {
    ...
    description: {
      ...
      ro: 'Aceste zgărzi care țin lupii în stare de servitute sunt fabricate dintr-o piele groasă. Unele încă mai au lanțuri atașate de ele, dar toate aceste zgărzi sunt robuste. Câteva dintre ele sunt îmbibate chiar și cu protecție spirituală.',
...

  {
    ...
    description: {
      ...
      ro: 'Acest colier a fost confecționat din fragmentele oaselor unei varietăți mari de creaturi puternice. Protecția fiecărui astfel de colier variază în funcție de originea oaselor.',
...

  {
    ...
    description: {
      ...
      ro: 'Ghearele unui vârcolac temut care au fost lăsate în urmă pe corpurile victimelor, au fost unse cu uleiuri mistice și insuflate cu tărie spirituală prin meditație. Creatorii acestor amulete au sperat că într-o zi acestea vor fi folosite pentru răzbunare.',
...

  {
    ...
    description: {
      ...
      ro: 'Când o gheară a fost găsită, aceasta a fost considerată un dar de la păsările sacre din munți. Călugării din munți au folosit aceste gheare pentru a produce amulete spirituale și a se proteja de invadatori în timpul bătăliilor.',
...

  {
    ...
    description: {
      ...
      ro: 'Oamenii antici ai deșertului au adunat pietre speciale iar apoi le-au încrustat în scarabei cu ajutorul unei magii negre, puternice. Mulți oameni importanți ai acele civilizații antice purtau aceste amulete pentru protecție și statură.',
...

  {
    ...
    description: {
      ...
      ro: 'Cioburi stranii găsite în minele din munți au fost înzestrate de mistici iar apoi transformate în amulete pentru a oferi protecție și a provoca frică.',
...

  {
    ...
    description: {
      ...
      ro: 'Teocrațiile de după război au creat simboluri Omega divine, ca un mijloc de protecție. Aceste simboluri au fost folosite pentru a împiedica atacurile, fiind considerate daruri de protecție și prezentate apoi potențialilor adepți religioși.',
...

  {
    ...
    description: {
      ...
      ro: 'Această amuletă are un set neobișnuit de discuri ce se suprapun și se conectează la energii naturale, astfel amplificând protecția naturală a purtătorului. Mulți magicieni se străduiesc să învețe secretele acestor amulete, astfel încât acestea să poată fi reproduse.',
...

  {
    ...
    description: {
      ...
      ro: 'Cabluri de metal se împletesc între ele, producând arcuri electrice și dându-i acestei amulete un aspect viu. Savanții speculează că acestea provin dintr-un tărâm pierdut, dar nimeni nu pare să fie sigur de acest lucru.',
...

  {
    ...
    description: {
      ...
      ro: 'Regii antici aveau puternice simboluri ankh făcute pentru a-i proteja în viața de apoi. Tâlharii de morminte au furat multe dintre aceste amulete și le-au vândut atât oamenilor cât și monștrilor. Fiecare simbol are o strălucire sinistră care lasă o impresie falsă asupra adevăratei sale puteri.',
...

  {
    ...
    description: {
      ...
      ro: 'Bucăți răsucite din enormul World Tree, Yggdrasil, au fost transformate în amulete de cel mai sacru fel. Seva ce iese din amuletă este absorbită de corp pentru extra protecție.',
...

  {
    ...
    description: {
      ...
      ro: 'Această amuletă conține magia Dragonului cel Bătrân care a fost transmisă mai departe dragonilor tineri; aceste amulete au oferit dragonilor tineri o șansă mai mare de supraviețuire în adolescență. Odată ce dragonii tineri au devenit bătrâni și suficient de mari pentru a supraviețui pe cont propriu, lanțul s-a rupt iar această amuletă s-a pierdut.',
...

  {
    ...
    description: {
      ...
      ro: 'Centrul acestei amulete fabricate din pene de pasăre Phoenix conține o cantitate mică de cenușă ce provine de la toți aventurierii căzuți care au deținut-o vreodată. Fără excepție, fiecare aventurier care a folosit vreodată o astfel de amuletă a devenit o legendă.',
