export default [
...

  {
    ...
    description: {
      ...
      fr: 'Les paladins acquièrent ce bouclier lorsqu\'ils atteignent un certain niveau de dévotion spirituelle. Cependant, ces boucliers de paladin sont parfois vus sans leurs propriétaires...',
...

  {
    ...
    description: {
      ...
      fr: 'Ce type de bouclier est fabriqué par des mortels avec de la glace que l\'on ne trouve que dans les enfers. Bien que le bouclier soit puissant, les propriétés inhabituelles et la rareté de la glace des enfers rendent les tentatives mortelles de reconstruire ces boucliers inadéquates au mieux.',
...

  {
    ...
    description: {
      ...
      fr: 'Ce bouclier sacré est enveloppé de légendes et de rumeurs. Un ancien parchemin raconte comment le bouclier a créé de fausses copies de l\'utilisateur pour déboussoler les adversaires. Un autre parchemin explique alternativement que le bouclier a été modelé après que ce même bouclier fut brandi par une divinité.',
...

  {
    ...
    description: {
      ...
      fr: 'La peinture divine sur ce bouclier est animée et peut imprégner de pouvoirs fantastiques un utilisateur digne. Certains observateurs pensent que l\'œil clignotant du bouclier permet au peintre mystérieux et divin de voir le monde.',
